...
import com.lockdoc.outpatient.service.CounterSessionService;
...
/** Counter session open/close & reconciliation (Master Spec §7.5/§11.5, screens #12/#31) - ?counterType=OP. */
@RestController
