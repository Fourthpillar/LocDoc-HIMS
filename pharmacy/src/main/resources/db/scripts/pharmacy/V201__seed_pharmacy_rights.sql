...
-- ---------------------------------------------------------------
-- Pharmacy rights (permissions) - one per @PreAuthorize authority
-- used across the pharmacy controllers
-- ---------------------------------------------------------------
INSERT INTO rights (right_code, right_name, description) VALUES
    ...
    ('PHARMACY_INVENTORY_READ',         'View Inventory',              'Ability to view medicines and stock/inventory levels'),
...
WHERE r.role_code = 'SUPER_ADMIN'
  AND rt.right_code IN (
    'PHARMACY_MEDICINE_MANAGE', 'PHARMACY_SUPPLIER_MANAGE',
