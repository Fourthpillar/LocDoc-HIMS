...
import com.lockdoc.app.dto.op.VisitChargePreviewResponse;
...
import com.lockdoc.app.repository.op.ConsultationRatingRepository;
...
public class OpVisitService {
    ...
    private final com.lockdoc.app.repository.op.ReferralDoctorRepository referralDoctorRepository;
    private final com.lockdoc.app.repository.op.ProRepository proRepository;
    ...
    public OpVisitResponse arrive(OpVisitRequest request) {
        ...
        com.lockdoc.app.entity.op.ReferralDoctor referralDoctor = null;
        ...
        com.lockdoc.app.entity.op.Pro pro = null;
     ...
     */
    public com.lockdoc.app.dto.op.BillResponse billConsultation(Long visitId) {
        Long facilityId = SecurityUtils.requireFacilityId();
        ...
        if (freeReviewAnchor.isPresent()) {
            ...
            freeReviewLinkRepository.save(FreeReviewLink.builder()
                    ...
                    .build());
            return com.lockdoc.app.dto.op.BillResponse.toResponse(freeBill);
        }
        ...
        return com.lockdoc.app.dto.op.BillResponse.toResponse(bill);
    }
